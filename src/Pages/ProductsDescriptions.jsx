...
// Import the same Mehndi Dresses list
const mehndiDresses = [
...
const ProductsDescriptions = () => {
    ...
    const product = mehndiDresses.find(item => item.id === parseInt(id)); // Convert id to number and find match
    useEffect(() => {
        window.scrollTo(0, 0)
    }, [])
    return (
                    ...
                    {product ? (
                        <div className="product-card">
                            ...
                            <div className="product-details">
                                ...
                                <b className="product-price">${product.price}</b> {/* Price is now above the button */}
